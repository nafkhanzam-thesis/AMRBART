...
args = Namespace(adam_epsilon=1e-08,
  ...
  model_name_or_path='../models/mt5-small',
  model_type='../models/mt5-small',
  no_cache=False,
  no_cuda=False,
  num_train_epochs=1000.0,
  output_dir='../outputs/amrbart-models-mt5-small-Unifiedtextinf-JointDenoise-6task-5e-5-AMREOS',
